...
Run both structural validation and semantic linting (DIP001–DIP010 + DIP101–DIP159).
...
**Checks**: All 67 diagnostic rules. Errors (DIP001–DIP010) cause exit code 1. Warnings (DIP101–DIP159) are reported but don't affect the exit code.
