...
Run both structural validation and semantic linting (DIP001–DIP010 + DIP101–DIP165).
...
**Checks**: All 75 diagnostic rules. Errors (DIP001–DIP010, plus the error-severity lints DIP155–DIP158 and DIP163) cause exit code 1. Warnings and hints (the rest of DIP101–DIP165) are reported but don't affect the exit code.
