...
| K | Graph-level `on_failure:` route (defaults + per-node) + DIP144 failure-route lint — #92/#93 | `ir.go: OnFailure`; `validator` DIP144 | edges.md, syntax.md(defaults+node), nodes.md, validation.md, llm-reference.md, skill.md, GRAMMAR.ebnf, examples/on_failure_route.dip |
