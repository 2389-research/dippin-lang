...
│   ├── lint.go         # Lint orchestration (DIP101-DIP160)
...
<div class="decision-grid">
  ...
  <div class="decision-card">
    ...
    <p>All 10 structural checks and all 60 semantic checks run unconditionally. A single call reports every issue, not just the first. This enables batch fixing.</p>
  </div>
  <div class="decision-card">
