...
<div class="cmd-card">
  ...
  <p>Run both structural validation and semantic linting (DIP001-DIP010 + DIP101-DIP159). All 67 diagnostic rules. Errors cause exit code 1; warnings alone exit 0.</p>
  <dl>
