...
- **Validate & Lint** — 75 diagnostic rules (DIP001-DIP010 structural, DIP101-DIP165 semantic) catch dead edges, unreachable nodes, missing prompts, and invalid models. See the [CLI Reference](/cli/).
