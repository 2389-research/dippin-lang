...
- [Validation & Linting](https://dippin.org/validation.html) — 64 diagnostic codes for AI pipeline workflows. 10 structural errors and 54 semantic warnings catch bugs before runtime.
