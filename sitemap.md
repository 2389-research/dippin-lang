...
- [Validation & Linting](https://dippin.org/validation.html) — 56 diagnostic codes for AI pipeline workflows. 10 structural errors and 46 semantic warnings catch bugs before runtime.
