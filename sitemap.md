...
- [Lint Rules](https://dippin.org/lint.html) — 65 semantic lint checks (DIP101–DIP165) that flag likely bugs and questionable patterns, grouped by concern. Run with dippin lint.
