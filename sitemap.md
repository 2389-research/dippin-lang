...
- [Validation & Linting](https://dippin.org/validation.html) — 67 diagnostic codes for AI pipeline workflows. 10 structural errors and 57 semantic checks catch bugs before runtime.
