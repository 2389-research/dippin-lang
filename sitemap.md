...
- [CLI Reference](https://dippin.org/cli.html) — Complete command reference for the Dippin toolchain: 18 commands for authoring, export, analysis, and bundling AI pipeline workflows — parse, validate, lint, check, fmt, simulate, cost, coverage, doctor, test, watch, pack, unpack, inspect, and more.
...
- [Validation & Linting](https://dippin.org/validation.html) — 61 diagnostic codes for AI pipeline workflows. 10 structural errors and 51 semantic warnings catch bugs before runtime.
