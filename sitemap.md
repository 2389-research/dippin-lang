...
- [Validation & Linting](https://dippin.org/validation.html) — 40 diagnostic checks for AI pipeline workflows. 9 structural errors and 31 semantic warnings catch bugs before runtime.
