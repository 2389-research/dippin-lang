...
- [Validation & Linting](https://dippin.org/validation.html) — 62 diagnostic codes for AI pipeline workflows. 10 structural errors and 52 semantic warnings catch bugs before runtime.
